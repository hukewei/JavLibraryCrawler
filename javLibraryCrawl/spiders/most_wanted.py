...
class BestRatedSpider(CrawlSpider):
    name = "most_wanted_spider"
    allowed_domains = ["javlibrary.com"]
    start_urls = [
        "http://www.javlibrary.com/cn/vl_mostwanted.php?&mode=&page=25",
    ]
    rules = (
        # Extract links matching 'category.php'
        # and follow links from them (since no callback means follow=True by default).
        Rule(SgmlLinkExtractor(allow=('vl_mostwanted\.php', ))),
    ...
    def parse_video(self, response):
        ...
        @url http://www.javlibrary.com/cn/vl_mostwanted.php
        @scrapes name
        """
