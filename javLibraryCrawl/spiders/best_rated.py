...
class BestRatedSpider(CrawlSpider):
    ...
    def parse_video(self, response):
        ...
        item['duration'] = video.xpath('//*[@id="video_length"]/table/tbody/tr/td[2]/span/text()').extract()
        item['release_date'] = video.xpath('//*[@id="video_date"]/table/tbody/tr/td[2]/text()').extract()
        items.append(item)
